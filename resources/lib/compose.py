...
def _sections(
    ...
    Each section contains lines and a ticks flag (whether to refresh by minute).
    """
...
def _to_content(sections: Sequence[dict[str, Any]], now_seconds: float) -> Content:
