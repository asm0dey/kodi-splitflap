...
- [screensaver.splitflap-0.1.15.zip](repo/screensaver.splitflap/screensaver.splitflap-0.1.15.zip)

## What's here

| Add-on | What it is |
|---|---|
| [`screensaver.splitflap`](repo/screensaver.splitflap/screensaver.splitflap-0.1.15.zip) | the screensaver |
