...
- [screensaver.splitflap-0.1.16.zip](repo/screensaver.splitflap/screensaver.splitflap-0.1.16.zip)

## What's here

| Add-on | What it is |
|---|---|
| [`screensaver.splitflap`](repo/screensaver.splitflap/screensaver.splitflap-0.1.16.zip) | the screensaver |
