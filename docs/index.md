...
- [screensaver.splitflap-0.1.12.zip](repo/screensaver.splitflap/screensaver.splitflap-0.1.12.zip)

## What's here

| Add-on | What it is |
|---|---|
| [`screensaver.splitflap`](repo/screensaver.splitflap/screensaver.splitflap-0.1.12.zip) | the screensaver |
